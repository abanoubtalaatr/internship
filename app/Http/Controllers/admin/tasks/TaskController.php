...
{
    protected function show_add(){
    	return view('admin.tasks.add');
    }// end show_add
    protected function show_show (){
    ...
    protected function show_delete(){
    ...
    protected function to_delete($id){
    	$task = Task::find($id);
        if($task->delete()){
    ...
    protected function single_edit($id){
    ...
    protected function compelete_edit(Request $request){
