...
<head>
  ...
  <link rel="stylesheet" href="{{asset('admins/dist/css/skins/skin-blue.min.css')}}">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Tasks</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu bg-info ">
            <li><a href="/admin/tasks/show">Show</a></li>
            <li><a href="/admin/tasks/add">Add</a></li>
            <li><a href="/admin/tasks/edit">Edit</a></li>
            <li><a href="/admin/tasks/delete">Delete</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu bg-info ">
            ...
            <li><a href="/admin/projects/edit">Edit</a></li>
            <li><a href="/admin/projects/delete">Delete</a></li>
